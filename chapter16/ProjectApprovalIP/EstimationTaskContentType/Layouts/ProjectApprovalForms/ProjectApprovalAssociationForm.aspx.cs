    ...
    public partial class ProjectApprovalAssociationForm : LayoutsPageBase
    {
        ...
        private string GetAssociationData()
        {
            ...
            XmlTextWriter writer = new XmlTextWriter(new StringWriter(sb));
             writer.WriteStartElement("my", "myFields", "http://schemas.microsoft.com/office/infopath/2003/myXSD");
             writer.WriteElementString("EstimationManager", "http://schemas.microsoft.com/office/infopath/2003/myXSD", EstimationManager.Text);
