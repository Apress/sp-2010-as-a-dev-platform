...
namespace EstimationTaskContentType.Layouts.ProjectApprovalForms
{
    public partial class EstimationTask : LayoutsPageBase
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            this.Page.Response.Write(string.Format(CultureInfo.InvariantCulture,"<script type=\"text/javascript\">window.frameElement.commonModalDialogClose(1, '{0}');</script>", null));
            this.Page.Response.End();
            //SPUtility.Redirect(this._taskList.DefaultViewUrl, SPRedirectFlags.Default, this.Context);
        }
    }
}
